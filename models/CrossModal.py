...
class VisionTransformer(nn.Module):
    def __init__(self, config):
        ...
        if self.backbone_name in clip._MODELS.keys():
            ...
            self.clip = False
            image_model = timm.create_model(self.backbone_name, pretrained=False,checkpoint_path='/home/ubuntu/home/ubuntu/deep-learning/HyperPoint/jx_vit_base_p16_224-80ecf9dd.pth')
...
class TextTransformer(nn.Module):
    ...
    def forward(self, text, index=0):
        ...
        text_feature=self.to_poincare(text_feature)
        return text_feature
